/*
 * fnx/include/fnx/filesystems.h
 *
 * Copyright 2018-2022, Jordi Sanfeliu. All rights reserved.
 * Distributed under the terms of the Fiwix License.
 */

#ifndef _FNX_FILESYSTEMS_H
#define _FNX_FILESYSTEMS_H

#include <fnx/types.h>
#include <fnx/limits.h>

#define NR_FILESYSTEMS		11	/* supported filesystems */
...
int pipefs_ioctl(struct inode *, struct fd *, int, addr_t);
...
int sockfs_ioctl(struct inode *, struct fd *, int, addr_t);
