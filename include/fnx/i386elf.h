...
/*
 * ELF32 types must be fixed-width: 'unsigned long' would silently grow to
 * 8 bytes when the kernel is built as -m64 (LP64) and corrupt every offset.
 */
...
/* FNX (native 64-bit port): minimal ELF64 definitions for the x86_64
