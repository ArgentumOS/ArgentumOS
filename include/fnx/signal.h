/*
 * fnx/include/fnx/signal.h
 *
 * Copyright 2018-2022, Jordi Sanfeliu. All rights reserved.
 * Distributed under the terms of the Fiwix License.
 */

#ifndef _FNX_SIGNAL_H
#define _FNX_SIGNAL_H

struct sigcontext;	/* forward declaration (fnx/sigcontext.h defines it) */
