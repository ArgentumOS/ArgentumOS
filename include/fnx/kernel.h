/*
 * fnx/include/fnx/kernel.h
 *
 * Copyright 2018-2023, Jordi Sanfeliu. All rights reserved.
 * Distributed under the terms of the Fiwix License.
 */

#ifndef _FNX_KERNEL_H
#define _FNX_KERNEL_H
...
#ifdef __x86_64__
extern addr_t _last_data_addr;	/* FNX: holds the high-half alias too */
#else
...
struct kernel_stat {
	...
	__u64 system_time;		/* current system time (since the Epoch) */
	__u64 boot_time;		/* boot time (since the Epoch) */
...
void start_kernel(unsigned int, unsigned int, unsigned long);
