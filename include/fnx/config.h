/*
 * fnx/include/fnx/config.h
 *
 * Copyright 2018-2023, Jordi Sanfeliu. All rights reserved.
 * Distributed under the terms of the Fiwix License.
 */

#ifndef _FNX_CONFIG_H
#define _FNX_CONFIG_H
...
#undef CONFIG_VM_SPLIT22
	...
	/* keep the -D definition: the FNX port needs the minix fs to
	 * mount its synthesized initrd (config.h otherwise undefs it) */
#else
