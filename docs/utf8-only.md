...
- **Config files** are UTF-8 (already specified in
  `docs/config-design.md` §10: "Encoding: UTF-8; an optional BOM at the
...
- `docs/fsh-proposal.md` — filesystem hierarchy; names are UTF-8.
- `docs/config-design.md` — `.conf` format is UTF-8.
- `docs/toybox-fsh-plan.md` — userland porting; the same encoding rule
