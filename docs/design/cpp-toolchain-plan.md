...
— **superseded at LLVM M2 (docs/design/llvm-clang-toolchain-plan.md): the C++
...
milestone spine is docs/design/self-hosting-plan.md):
...
- Userland C toolchain: `tools/musl-clang64.sh` — clang with the
  musl/FSH link contract (docs/design/llvm-clang-toolchain-plan.md §3; the
