...
| OS look & feel | Appearance Manager | **the ported toolkit** (the own-toolkit/libwidgets direction was superseded and removed; see `docs/archive/gui-e-toolkit.md`) — Platinum is built in, not bolted on |
