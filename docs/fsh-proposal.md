...
Status: DRAFT — for discussion. Source notes: `docs/fsh-notes.txt`.
...
The layout below is the original design from `docs/fsh-notes.txt`, argued
...
2. The kernel reads its options from `/System/ESP/kernel.conf`
   ...
   `docs/config-design.md` §11), via early ESP access: the FAT32
