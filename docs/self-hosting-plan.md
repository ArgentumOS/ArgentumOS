...
- `docs/llvm-clang-toolchain-plan.md` — the **Clang migration** (M1..M5):
...
- `docs/cpp-toolchain-plan.md` §1 — the toolchain-direction note for the
  ...
  sysroot.
- `docs/shared-libraries-plan.md` — **dynamic linking** (decided): shared
  userland libraries, static recovery set kept.
- `docs/os-profile.md` + `4229be1` — the doctrine: one system compiler =
...
**Acceptance:** the `cpp_smoke` battery (docs/cpp-toolchain-plan.md P3)
